        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Summary = table.Column<string>(type: "nvarchar(2600)", maxLength: 2600, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MockInterview = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SkillGapAnalyses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SkillGapAnalyses_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Certifications_UserProfiles_ProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProfileSkills_UserProfiles_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkillGapItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SkillGapItems_SkillGapAnalyses_AnalysisId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SkillGapAnalyses_JobId",
                table: "SkillGapAnalyses",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_SkillGapAnalyses_UserId",
                table: "SkillGapAnalyses",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SkillGapItems_AnalysisId",
                table: "SkillGapItems",
                column: "AnalysisId");
